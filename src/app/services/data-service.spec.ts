import * as productItemsFixtures from '@frontend-cart/api/fixtures/product-items';
import * as productDiscountFixtures from '@frontend-cart/api/fixtures/product-discounts';
